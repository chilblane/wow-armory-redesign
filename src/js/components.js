...
function AjaxContent(t) {
    ...
    this.url = t.getAttribute("data-url"),
    this.init()
}
...
AjaxContent.prototype = {
    ...
    ajax: function(t, e) {
        function i() {
            this.stopLoading(),
            n.status < 400 ? e(n.responseText, n) : this.error(n)
        }
        if (!t)
            return null;
        this.startLoading();
        var n = new XMLHttpRequest;
        return n.onerror = this.error.bind(this),
        n.onload = i.bind(this),
        n.open("GET", encodeURI(t), !0),
        n.send(),
        n
    },
    update: function(t) {
        t && this.elem.setAttribute("url", t),
        this.url = this.elem.getAttribute("url"),
        this.ajax(this.url, this.load.bind(this))
    },
    error: function(t) {
        this.elem.setAttribute("disabled", ""),
        this.elem.trigger("error", t.status)
    },
    load: function(t) {
...
function Carousel(e) {
    this.elem = e,
    this.id = e.getAttribute("data-identifier"),
    this.carouselItems = Array.prototype.slice.call(e.querySelectorAll(".Carousel-item")),
...
function CarouselTimelineReboot(e) {
    ...
    this.next = e.querySelector(".Carousel-next"),
    this.previous = e.querySelector(".Carousel-prev"),
    this.hasTimelineArrows = e.classList.contains("Carousel-timelineArrows"),
    this.init()
}
Object.assign(Carousel, {
    ...
    "switch": function(e, t, i, s) {
        ...
        n = ".CarouselLink" + i.attributeSelector("data-carousel", "data-carousel-index"),
        document.querySelectorAll(n).map(function(e) {
            e.classList.add("is-selected")
        }),
        !s && e.isSnap && e.snapToTop(e.elem),
        e.elem.trigger("carouselchange")
    },
    select: function(e, t, i, s, n) {
        if (t != i)
            if (Carousel["switch"](e, t, i, s),
            null != t && !s && e.isAnimated && supports.transitionEnd) {
                var a = Carousel.getTransitionDistance(e)
                  ...
                  , u = "right" == n;
                if (o > r && !l || u)
                    return Carousel.setupAnimation(e, null, t, i),
                    Carousel.startSnapAnimation(e),
                    void Carousel.snapRight(e, a);
                (o < r || l) && (Carousel.setupAnimation(e, i, t, null),
                Carousel.startSnapAnimation(e),
                Carousel.snapLeft(e, a))
            } else
                trigger("resize"),
                e.isChanging = !1
    },
    setupAnimation: function(e, t, i, s) {
        ...
        t && (e.swipeLeftElem = t,
        t.classList.add("Carousel-prevFrame"),
        t.style.transform = "translate(" + -n + "px, 0)",
        ...
        s && (e.swipeRightElem = s,
        s.classList.add("Carousel-nextFrame"),
        s.style.transform = "translate(" + n + "px, 0)",
        window.getComputedStyle(s).transform),
        e.hasLayout || trigger("resize")
    },
    endAnimation: function(e) {
        e.swipeLeftElem && (e.swipeLeftElem.classList.remove("Carousel-prevFrame"),
        e.swipeLeftElem.style.transform = "",
        e.swipeLeftElem.classList.remove("is-active"),
        e.swipeLeftElem = null),
        e.swipeRightElem && (e.swipeRightElem.classList.remove("Carousel-nextFrame"),
        e.swipeRightElem.style.transform = "",
        e.swipeRightElem.classList.remove("is-active"),
        e.swipeRightElem = null),
        e.swipeCenterElem && (e.swipeCenterElem.classList.remove("Carousel-currentFrame"),
        e.swipeCenterElem.style.transform = "",
        e.swipeCenterElem = null),
        e.hasLayout || trigger("resize"),
        e.isAnimating = !1
    },
    startSnapAnimation: function(e) {
        e.isChanging = !0,
        e.swipeLeftElem && e.swipeLeftElem.classList.add("Carousel-transitioning"),
        e.swipeRightElem && e.swipeRightElem.classList.add("Carousel-transitioning"),
        e.swipeCenterElem && (e.swipeCenterElem.classList.add("Carousel-transitioning"),
        e.swipeCenterElem.addEventListener(supports.transitionEnd, e.transitionEventHandler))
    },
    ...
    snapBack: function(e, t) {
        e.swipeLeftElem && Carousel.translateViewportLeft(e.swipeLeftElem, t),
        Carousel.translateViewportCenter(e.swipeCenterElem),
        e.swipeRightElem && Carousel.translateViewportRight(e.swipeRightElem, t)
    },
    snapLeft: function(e, t) {
        e.swipeLeftElem && (Carousel.translateViewportCenter(e.swipeLeftElem),
        e.swipeLeftElem.classList.add("is-active")),
        e.swipeCenterElem && Carousel.translateViewportRight(e.swipeCenterElem, t),
        e.swipeRightElem && Carousel.translateViewportRight(e.swipeRightElem, t)
    },
    snapRight: function(e, t) {
        e.swipeLeftElem && Carousel.translateViewportLeft(e.swipeLeftElem, t),
        e.swipeCenterElem && Carousel.translateViewportLeft(e.swipeCenterElem, t),
        e.swipeRightElem && (Carousel.translateViewportCenter(e.swipeRightElem),
        e.swipeRightElem.classList.add("is-active"))
    },
    stopSnapAnimation: function(e) {
        e.swipeLeftElem && (e.swipeLeftElem.classList.remove("Carousel-transitioning"),
        e.swipeLeftElem.classList.remove("is-active")),
        e.swipeRightElem && (e.swipeRightElem.classList.remove("Carousel-transitioning"),
        e.swipeRightElem.classList.remove("is-active")),
        e.swipeCenterElem && e.swipeCenterElem.classList.remove("Carousel-transitioning"),
        e.isChanging = !1
    },
...
Carousel.prototype = {
    ...
    showNext: function() {
        if (!this.isChanging) {
            this.isChanging = !0;
            var e, t = this.elem, i = t.querySelector(".Carousel-item.is-selected"), s = this.carouselItems.indexOf(i);
            e = s >= this.carouselItems.length - 1 ? this.carouselItems[0] : this.carouselItems[s + 1],
            Carousel.select(this, i, e, null, "right")
        }
    },
    showPrevious: function() {
        if (!this.isChanging) {
            this.isChanging = !0;
            var e, t = this.elem, i = t.querySelector(".Carousel-item.is-selected"), s = this.carouselItems.indexOf(i);
            e = s <= 0 ? this.carouselItems[this.carouselItems.length - 1] : this.carouselItems[s - 1],
            Carousel.select(this, i, e, null, "left")
        }
    },
    ...
    touchStart: function(e) {
        if (1 != e.touches.length || this.isChanging)
            this.isSwiping = !1;
        else {
            this.isSwiping = !0,
    ...
    touchEnd: function(e) {
        if (this.isSwiping) {
            if (this.isTouchMoved) {
                ...
                i > t / 2 ? (Carousel["switch"](this, this.swipeCenterElem, this.swipeLeftElem),
                this.isAnimated && (supports.transitionEnd ? (Carousel.startSnapAnimation(this),
                Carousel.snapLeft(this, t)) : requestAnimationFrame(this.endSwipeAnimationBound))) : i < -(t / 2) ? (Carousel["switch"](this, this.swipeCenterElem, this.swipeRightElem),
                this.isAnimated && (supports.transitionEnd ? (Carousel.startSnapAnimation(this),
                Carousel.snapRight(this, t)) : requestAnimationFrame(this.endSwipeAnimationBound))) : this.isAnimated && (supports.transitionEnd ? (Carousel.startSnapAnimation(this),
                Carousel.snapBack(this, t)) : requestAnimationFrame(this.endSwipeAnimationBound))
            }
            this.isSwiping = !1,
        ...
        if (this.isSwiping)
            if (1 != e.touches.length)
                ...
                if (t >= this.swipeMoveThreshold) {
                    ...
                    if (this.swipeDistance += Math.sqrt(s * s + n * n),
    ...
    startSwipeAnimation: function() {
        var e, t = this.elem.querySelector(".Carousel-item.is-selected"), i = this.carouselItems.indexOf(t);
        e = i < 1 ? this.carouselItems[this.carouselItems.length - 1] : this.carouselItems[i - 1];
        var s;
        s = i > this.carouselItems.length - 2 ? this.carouselItems[0] : this.carouselItems[i + 1],
        Carousel.setupAnimation(this, e, t, s)
    },
    ...
    updateSwipeAnimation: function() {
        ...
        this.swipeLeftElem.style.transform = "translate(" + (-e + t).toFixed(0) + "px, 0)",
        this.swipeCenterElem.style.transform = "translate(" + t.toFixed(0) + "px, 0)",
        this.swipeRightElem.style.transform = "translate(" + (e + t).toFixed(0) + "px, 0)",
        t > 0 ? (this.swipeLeftElem.classList.add("is-active"),
    ...
    stickyUpdate: function() {
        ...
        this.previous.style.transform = "translateY(" + n + "px)",
        this.next.style.transform = "translateY(" + n + "px)"
    },
...
CarouselTimelineReboot.prototype = {
    ...
    handleTimelineArrows: function() {
        ...
        i.dataset.prevUrl || (document.querySelector(".Carousel-prev").classList.add("hide"),
        t = !0),
        i.dataset.nextUrl || (document.querySelector(".Carousel-next").classList.add("hide"),
        e = !0),
        e || this.handleTimelineNextNavigation(),
        t || this.handleTimelinePrevNavigation()
    },
...
function CarouselIndicator(e) {
    this.elem = e,
    e.carouselIndicator = this,
    this.carouselIdentifier = e.getAttribute("data-indicator"),
    this.nodeContainer = e.querySelector(".CarouselIndicator-nodes"),
    this.nodes = e.querySelectorAll(".CarouselIndicator-node"),
...
CarouselIndicator.prototype = {
    ...
    populateNodes: function() {
        if (this.carouselItems) {
            for (var e = 0; e < this.carouselItems.length; e++)
                this.buildNodeElement(e);
    ...
    buildNodeElement: function(e) {
        ...
        t.setAttribute("class", "CarouselIndicator-node"),
        t.setAttribute("data-indicator-index", e);
        var i = document.createElement("div");
        i.setAttribute("class", "CarouselLink"),
        i.setAttribute("data-carousel", this.carouselIdentifier),
        i.setAttribute("data-carousel-index", e);
        ...
        i.appendChild(s),
        t.appendChild(i),
        this.nodeContainer.appendChild(t)
    },
    selectActiveNode: function() {
        if (this.carouselItems) {
            for (var e = 0, t = 0; t < this.carouselItems.length; t++)
                this.carouselItems[t].classList.contains("is-selected") && (e = this.carouselItems[t].getAttribute("data-carousel-index"));
...
function CarouselTimeline(e) {
    this.elem = e,
    this.carouselIdentifier = e.getAttribute("data-timeline"),
    this.leftEndCap = e.querySelector(".CarouselTimeline-endCapLeft"),
    this.rightEndCap = e.querySelector(".CarouselTimeline-endCapRight"),
    this.scrollable = e.querySelector(".Scrollable"),
    this.nodeContainer = e.querySelector(".CarouselTimeline-nodes"),
    this.nodes = e.querySelectorAll(".CarouselTimeline-node"),
    this.isInline = e.classList.contains("CarouselTimeline--inline"),
    this.maxWidth = .8,
...
Object.assign(CarouselTimeline, {
    ...
    calcIndex: function(e, t, i, n) {
        var s = i + n / t;
        return s = n < 0 ? Math.ceil(s) : Math.floor(s),
...
CarouselTimeline.prototype = {
    ...
    listen: function() {
        if (window.addEventListener("resize", this.resize.bind(this)),
        this.nodes.map(function(e) {
            e.addEventListener("touchstart", this.touchStart.bind(this, parseInt(e.getAttribute("data-timeline-index")))),
            e.addEventListener("touchmove", this.touchMove.bind(this, parseInt(e.getAttribute("data-timeline-index"))))
        }
        .bind(this)),
    ...
    update: function() {
        ...
        if (i > t) {
            ...
            s < this.dotWidth ? this.isCompact || (this.isCompact = !0,
            this.nodeContainer.classList.add("is-compact")) : this.isCompact && (this.isCompact = !1,
            this.nodeContainer.classList.remove("is-compact")),
            this.nodeWidth = parseInt(s),
            this.nodeContainer.classList.add("is-constrained")
        } else
            this.isConstrained && (this.isConstrained = !1,
            this.nodes.map(function(e) {
                e.style.width = ""
            }),
    ...
    touchEnd: function(e) {
        ...
        e.stopPropagation(),
        e.preventDefault(),
        null != this.activeNodeIndex && (this.nodes[this.activeNodeIndex].querySelector(".CarouselLink").click(),
        this.activeNodeIndex = null,
        requestAnimationFrame(this.updateActiveNodeBound)))
    },
    ...
    touchMove: function(e, t) {
        if (this.isTouching) {
            ...
            this.activeNodeIndex != n && (this.activeNodeIndex = n,
            requestAnimationFrame(this.updateActiveNodeBound))
        }
    },
    updateActiveNode: function() {
...
Clone.prototype = {
    ...
    load: function(e) {
        e && !this.isCloned && (this.elem.classList.add(Clone.cloneClass),
        e.classList.add(Clone.cloneClass),
        e.childNodes.each(function(e) {
...
Object.assign(Dropdown, {
    ...
    addActive: function(o) {
        o.classList.add(Dropdown.activeClass),
        o.querySelectorAll(".SyncHeight").map(Dropdown.updateSync)
    },
    ...
    select: function(o) {
        ...
        DropdownLink.findAllInGroup(o).map(Dropdown.removeActive)) : (Dropdown.elems.map(Dropdown.removeActive),
        DropdownLink.elems.map(Dropdown.removeActive)),
        e ? Dropdown.active = !1 : (Dropdown.findAll(o).map(Dropdown.addActive),
        DropdownLink.findAll(o).map(Dropdown.addActive),
        DropdownLink.findAll(o).map(Dropdown.addOverlap),
        Dropdown.active = !0)
    },
    findAll: function(o) {
    ...
    closeAll: function() {
        Dropdown.elems.map(Dropdown.removeActive),
        DropdownLink.elems.map(Dropdown.removeActive)
    }
}),
Dropdown.prototype = {
...
function DropdownLink(t) {
    this.elem = t,
    this.elem.dropdownLink = this,
    this.hasDropdownExternal = this.elem.classList.contains("DropdownLink--external"),
    this.init()
}
...
DropdownLink.prototype = {
    init: function() {
        if (DropdownLink.elems.push(this.elem),
        this.elem.addEventListener("click", this.select.bind(this, this.elem)),
        this.elem.addEventListener("mousedown", DropdownLink.stop),
        this.hasDropdownExternal = this.elem.classList.contains("DropdownLink--external"),
        this.hasDropdownExternal) {
            ...
            this.slug) {
                var e = "/story/timeline/" + this.slug
                  , n = document.querySelectorAll(".TabsLink.DropdownMenu-menuLink").filter(function(t) {
                    if (t.getAttribute("href") == e || t.getAttribute("href") + "timeline" == e)
                        return t
                })
    ...
    select: function(t, e) {
        this.hasDropdownExternal && document.querySelector(".Dropdown--timelineAbsolute").classList.add("is-active"),
        "INPUT" === e.target.nodeName && t.classList.contains(Dropdown.activeClass) || Dropdown.select(t),
        e.stopPropagation()
    }
},
DropdownLink.init();
...
Object.assign(Expand, {
    ...
    addActive: function(n) {
        n.classList.add(Expand.activeClass),
        n.expand.expandLinks.map(ExpandLink.addActive.bind(this))
    },
    removeActive: function(n) {
        n.classList.remove(Expand.activeClass),
        n.expand.expandLinks.map(ExpandLink.removeActive.bind(this))
    },
    select: function(n) {
    ...
    isAnimated: function(n) {
        for (var t in Expand.animationClasses)
            if (n.classList.contains(Expand.animationClasses[t]))
                return !0;
        return !1
    }
}),
Expand.prototype = {
    init: function() {
        ...
        this.isAnimated && (this.elem.classList.contains("Expand--fade") ? this.animation = new ExpandAnimationFade(this) : this.elem.classList.contains("Expand--grow") && (this.animation = new ExpandAnimationGrow(this))),
        this.contentContainer = this.elem.querySelector("." + Expand.contententContainerClass),
        this.expandLinks = document.querySelectorAll(".ExpandLink" + this.elem.attributeSelector(Expand.attr))
    },
    select: function() {
        this.toggle()
    },
...
function ExpandAnimationFade(n) {
    this.expand = n,
    this.expand.elem.addEventListener("animationend", ExpandAnimationFade.endAnimation, !1)
}
Object.assign(ExpandAnimationFade, {
    ...
    "in": function(n) {
        Expand.addActive(n),
        ExpandAnimationFade.removeOutClass(n),
        ExpandAnimationFade.addInClass(n)
    },
    out: function(n) {
        ExpandAnimationFade.removeInClass(n),
        ExpandAnimationFade.addOutClass(n)
    },
...
function ExpandAnimationGrow(n) {
    this.expand = n,
    this.expand.elem.addEventListener("transitionend", ExpandAnimationGrow.endTransition, !1),
    this.init()
}
Object.assign(ExpandAnimationGrow, {
    ...
    setHeight: function(n, i) {
        if (void 0 === i)
            n.style.height = n.expand.contentContainer.clientHeight + "px";
        else if (null === i)
    ...
    endTransition: function(n) {
        var i = n.target;
        Expand.isActive(i) && ExpandAnimationGrow.setHeight(i, "auto"),
        ExpandAnimationGrow.removeInClass(i),
        ExpandAnimationGrow.removeOutClass(i)
    }
}),
ExpandAnimationGrow.prototype = {
    ...
    animate: function() {
        ...
        Expand.isActive(this.expand.elem) ? (ExpandAnimationGrow.removeInClass(n),
        ExpandAnimationGrow.addOutClass(n),
        ExpandAnimationGrow.setHeight(n),
        requestAnimationFrame(function() {
            ExpandAnimationGrow.setHeight(n, 0),
            Expand.removeActive(n)
        })) : (Expand.addActive(n),
        ExpandAnimationGrow.removeOutClass(n),
        ExpandAnimationGrow.addInClass(n),
        ExpandAnimationGrow.setHeight(n))
    }
},
...
Object.assign(ExpandLink, {
    ...
    stop: function(n) {
        "INPUT" != n.target.nodeName && (n.preventDefault(),
        n.stopPropagation())
    },
    addActive: function(n) {
...
ExpandLink.prototype = {
    init: function() {
        ...
        this.elem.addEventListener("click", ExpandLink.stop);
...
function ImageNav(t) {
    ...
    this.imageNavList = t.querySelector(".ImageNav-list"),
    this.imageNavListItems = t.querySelectorAll(".ImageNav-listItem"),
    this.isDefault = t.classList.contains("ImageNav--default"),
    this.isMatchSlug = t.classList.contains("ImageNav--matchSlug"),
    this.imageNavTimeline = 0 != document.querySelector(".Carousel-desktopView"),
    this.init()
}
...
ImageNav.prototype = {
    ...
    findSlugMatch: function() {
        if (!this.isMatchSlug)
            return !1;
        if (this.slug) {
            var t, e = this.imageNavTimeline, i = e ? "/" + this.slug : this.slug;
    ...
    selectItem: function(t) {
        ...
        t.classList.add("ImageNav-listItem--selected")
    },
...
function ModalLink(e) {
    ...
    this.modalType = e.getAttribute("data-modal"),
    this.youtubeId = e.getAttribute("data-youtube-id"),
    this.neteaseId = e.getAttribute("data-netease-id"),
    this.contentFlex = e.getAttribute("data-content-flex"),
    this.init()
}
Object.assign(ModalLink, {
    ...
    buildModal: function(e, t) {
        ...
        c.addEventListener("click", ModalLink.closeModal);
        var r = document.createElement("div");
        r.classList.add("Modal-dialog"),
        r.addEventListener("click", ModalLink.closeModal);
        var u = document.createElement("div");
        u.classList.add("Modal-close"),
        u.addEventListener("click", ModalLink.closeModal);
        var m = document.createElement("div");
        m.classList.add("Icon"),
        m.classList.add("Icon--closeGold"),
        m.classList.add("Modal-closeIcon");
        var b = document.createElement("div");
        b.classList.add("Modal-content"),
        o && b.classList.add("Modal-content-flex"),
        b.addEventListener("click", ModalLink.closeModal);
        var p;
        if ("video" == e)
            if (d)
                p = ModalLink.buildYouTubePlayer(d);
            else {
            ...
            p = ModalLink.buildImage(n);
        else if ("comic" == e) {
            var A = t.getAttribute("data-comic-url");
            p = ModalLink.buildComicViewer(A),
            r.classList.add("Modal-dialog--comic")
        } else if ("html" == e) {
            var y = i || "#" == n[0];
            y ? (i = i || n.slice(1),
            p = ModalLink.html[i],
            p || (p = ModalLink.html[i] = a(i))) : p = AjaxContent.createElement(n)
        }
        p && b.appendChild(p),
        u.appendChild(m),
        r.appendChild(b),
        ...
        ModalLink.activeModal = s
    },
    buildComicViewer: function(e) {
        var t = document.createElement("iframe");
        return t.classList.add("Modal-comic"),
        t.setAttribute("src", e + "/modal"),
    ...
    buildYouTubePlayer: function(e) {
        var t = document.createElement("iframe");
        return t.classList.add("Modal-video"),
        t.setAttribute("src", "//www.youtube.com/embed/" + e + "?autoplay=1"),
        t.setAttribute("frameborder", "0"),
        t.setAttribute("allowfullscreen", ""),
        t
    },
    buildNetEasePlayer: function(e, t, a, i, d, l, o) {
        ...
        s.classList.add("Modal-video"),
        s.setAttribute("width", "100%"),
        s.setAttribute("height", "100%"),
        s.setAttribute("data", "https://nos.163.com/wow/1/swf/NetEaseFlvPlayerV3.swf"),
        ...
        r.setAttribute("value", "always"),
        r.setAttribute("name", "allowscriptaccess"),
        u.setAttribute("value", "https://nos.163.com/wow/1/swf/NetEaseFlvPlayerV3.swf"),
        u.setAttribute("allownetworking", "all"),
        u.setAttribute("name", "movie"),
        m.setAttribute("value", n(e, t, a, i)),
        m.setAttribute("name", "flashvars"),
        s.appendChild(c),
        s.appendChild(r),
        s.appendChild(u),
        s.appendChild(m);
        var b = ModalLink.buildNetEaseFallback(d, l, o);
        return b && s.appendChild(b),
        s
    },
    buildNetEaseFallback: function(e, t, a) {
        ...
        if (d.classList.add("Modal-videoFallbackMessage"),
        d.appendChild(l),
        t && a) {
            var o = document.createElement("a")
              , n = document.createTextNode(t);
            o.setAttribute("href", a),
            o.classList.add("Modal-videoFallbackLink"),
            o.appendChild(n),
            d.appendChild(o)
        }
    ...
    buildImage: function(e) {
        ...
        return t.classList.add("Modal-image"),
        t.setAttribute("src", e),
        t
    },
    buildHTML: function(e) {
        var t = document.createElement("div");
        return t.classList.add("Modal-html"),
    ...
    closeModal: function(e) {
        this == e.target && ModalLink.activeModal && (ModalLink.resumeVideos(),
    ...
    pauseVideos: function() {
        ...
        document.querySelectorAll("video").map(function(e) {
            e.paused || (e.pause(),
            ModalLink.videos.push(e))
        })
    },
    ...
    init: function() {
        document.querySelectorAlways(".ModalLink, .lightbox", ModalLink.create),
...
ModalLink.prototype = {
    init: function() {
        ...
        ("comic" == this.modalType || "image" == this.modalType || "html" == this.modalType || "video" == this.modalType && (this.youtubeId || this.neteaseId) && supports.video) && this.elem.addEventListener("click", this.onclick.bind(this))
    },
    onclick: function(e) {
...
function Pagination(t) {
    ...
    this.url = t.getAttribute("data-url"),
    this.page = parseInt(t.getAttribute("data-page")) || 1,
    this.total = parseInt(t.getAttribute("data-total")) || 1,
    this.size = t.getAttribute("data-size"),
    this.start = t.getAttribute("data-start"),
    this.end = t.getAttribute("data-end"),
    this.nav = t.querySelector(".Pagination-nav"),
    this.loadmore = t.querySelector(".Pagination-loadmore"),
    this.container = t.querySelector(".Pagination-pages"),
    this.pages = [],
...
Pagination.prototype = {
    ...
    preloadPage: function(t) {
        var i = this.pages[t - 1];
        i || (i = this.addPage(t),
        i.addEventListener("loading", function() {
    ...
    addPage: function(t) {
        ...
        this.pages[t - 1] = i,
        i.addEventListener("load", this.stopLoading.bind(this)),
        this.startLoading();
        var e = this.findNextPage(t);
        return e ? this.container.insertBefore(i, e) : this.container.appendChild(i),
        i
    },
    createPage: function(t) {
        var i = AjaxContent.createElement(this.createUrl(t));
        return i.classList.add("Pagination-page"),
    ...
    startLoading: function() {
        this.loadmore && this.loadmore.setAttribute("disabled", ""),
        this.elem.classList.add("is-loading")
    },
    stopLoading: function() {
        this.loadmore && this.loadmore.removeAttribute("disabled"),
        this.elem.classList.remove("is-loading")
    }
},
Pagination.init();
...
Pane.prototype = {
    ...
    renderFading: function() {
        ...
        if (t.top >= 0)
            ...
            this.bg.style.opacity = e < 1 ? e.toFixed(2) : null,
            this.isFaded = !0,
            this.forceFadeUpdate = !1
        }
    }
...
function Panel(i) {
    ...
    this.video = i.querySelector(".Panel-video"),
...
Panel.prototype = {
    ...
    videoInit: function() {
        this.disabled() ? this.video.src = "" : (this.video.src = this.video.getAttribute("data-src"),
        this.video.play(),
...
function PatchNotes(e) {
    ...
    this.body = e.querySelector(".PatchNotes-body"),
    this.expandElem = e.querySelector(".PatchNotes-expand"),
    this.collapseElem = e.querySelector(".PatchNotes-collapse"),
    this.init()
}
...
PatchNotes.prototype = {
    ...
    listen: function(e, t) {
        ...
        e.addEventListener("mousedown", PatchNotes.stop)
    },
    expand: function() {
...
function Poll(t) {
    this.elem = t,
    this.elem.Poll = this,
    this.form = t.querySelector(".Poll-vote"),
    this.url = t.getAttribute("data-url"),
    this.maxChoices = null != this.form ? this.form.getAttribute("data-choices") : 0,
    this.numSelected = 0,
    this.submitted = !1,
    this.init()
}
...
Poll.prototype = {
    init: function() {
        if (null != this.form) {
            ...
            for (var t = 0; t < this.selectionBoxes.length; t++)
                this.selectionBoxes[t].addEventListener("click", this.onSelect.bind(this, this.selectionBoxes[t]))
        }
    },
    onSubmit: function(t) {
        function e() {
        ...
        s.onload = e.bind(this),
        s.send(n.join("&"))
    },
    onSelect: function(t) {
        1 == this.maxChoices ? this.submitted || (this.form.submitBtn.disabled = !1) : (t.checked ? this.numSelected >= this.maxChoices ? t.checked = !1 : this.numSelected++ : this.numSelected--,
...
function ProgressDonut(t) {
    ...
    this.decimal = this.elem.getAttribute("data-decimal"),
    this.init()
}
...
ProgressDonut.createPath = function(t, e) {
    ...
    var s = e && this.percent > 50
      , i = !e && this.percent < 50;
    return (s || i) && (this.largeFlag = 1),
    this.sweepFlag = 1,
    e || (this.sweepFlag = 0),
    this.percent >= 100 && (this.endpointX = 49.9999,
    this.endpointY = 0),
...
ProgressDonut.prototype = {
    init: function() {
        ...
        t && (this.unfilledPath.setAttribute("d", ProgressDonut.createPath(this.decimal, !1)),
        this.filledPath.setAttribute("d", ProgressDonut.createPath(this.decimal, !0)))
    }
},
ProgressDonut.init();
...
Scrollable.prototype = {
    movingThreshold: 200,
    init: function() {
        this.elem.addEventListener("wheel", this.onmousewheel.bind(this)),
        this.elem.Scrollable = this,
...
function SelectMenu(e) {
    ...
    this.windowListening = !1,
    this.maxResults = this.elem.dataset.maxResults || SelectMenu.maxResults,
...
SelectMenu.prototype = {
    ...
    listen: function() {
        var e = this;
        e.input.addEventListener("input", e.onInput.bind(e)),
        e.toggle.addEventListener("click", e.onToggleClick.bind(e)),
    ...
    openMenu: function() {
        ...
        this.focusInput(),
        this.windowListening || (window.addEventListener("click", this.onWindowClick.bind(this)),
        this.windowListening = !0)
    },
    closeMenu: function() {
    ...
    onInput: function() {
        ...
        this.hideDefaults(),
        e = e.toLowerCase();
        for (var t = [], s = 0; s < this.items.length && !(this.valueMatches(this.items[s], e) && (t.push(this.items[s]),
        t.length >= this.maxResults)); s++)
            ;
        for (var i = t.length > this.maxResults ? this.maxResults : t.length, s = 0; s < i; s++)
            this.showItem(t[s]),
            this.showItem(t[s].parentNode);
        var n = t.length > 0;
        n ? this.addHasMatches() : (this.removeHasMatches(),
        this.showException())
    },
...
function SiteNav(e) {
    ...
    this.searchInput = e.querySelector(".SiteNav-searchInput"),
    this.searchDropdown = e.querySelector(".SiteNav-searchDropdown"),
    this.searchLinks = e.querySelectorAll(".SiteNav-searchLink"),
    this.searchInline = e.querySelector(".SiteNav-searchInlineInput"),
    this.searchInlineDropdown = e.querySelector(".SiteNav-searchInlineDropdown"),
    this.stickyElem = e.querySelector(".SiteNav-sticky"),
    this.mobileMenu = e.querySelector(".SiteNav-mobile-menu"),
    this.globalMenu = e.querySelector(".SiteNav-global-menu"),
    this.navbar = document.querySelector(".BnetNav .nav-global-menu-icon"),
    this.overlay = e.querySelector(".SiteNav-mobileOverlay"),
    this.init()
}
Object.assign(SiteNav, {
    ...
    getStickyOffset: function() {
        for (var e, t, i = document.querySelectorAll(".SiteNav"), n = 0, s = 0; s < i.length; s++)
            e = i[s].querySelector(".SiteNav-sticky"),
            e && e.classList.contains("is-active") && (t = i[s].querySelector(".SiteNav-area"),
            t && (n += t.offsetHeight));
        return n
    }
}),
SiteNav.prototype = {
    init: function() {
        ...
        this.searchInline.addEventListener("focus", this.focus.bind(this)),
        this.searchInline.addEventListener("blur", this.clear.bind(this, this.searchInline)),
        this.listen(this.searchInline),
        this.searchLinks.map(this.listen.bind(this)),
        this.stickyElem.addEventListener("update", e.bind(this)),
        window.addEventListener("resize", e.bind(this)),
        this.globalMenu.addEventListener("click", t(this.navbar)),
        this.overlay.addEventListener("click", t(this.mobileMenu))
    },
    listen: function(e) {
        function t() {
    ...
    onStickyUpdate: function() {
        ...
        e ? this.elem.classList.add("SiteNav--thinFull") : this.elem.classList.remove("SiteNav--thinFull"),
...
SocialButtons.prototype = {
    init: function() {
        for (var t = this.elem.getElementsByClassName("SocialButtons-link"), i = 0; i < t.length; i++)
            t[i].onclick = function() {
                return SocialButtons.openPopup(this.getAttribute("href"), this.getAttribute("data-popup-height"), this.getAttribute("data-popup-width")),
                !1
            }
    }
},
...
SortTable.prototype = {
    ...
    sort: function() {
        ...
        if (this.labels.map(function(t) {
            t.classList.contains("is-sorted") ? (s = t,
            o = !1) : t.classList.contains("is-sorted-reverse") && (s = t,
            o = !0)
        }),
        s) {
            var a = s.index
...
function Sticky(t) {
    ...
    this.offset = 0,
    this.isActive = Sticky.checkActive(t),
    this.isStuck = !1,
...
Object.assign(Sticky, {
    ...
    resize: function() {
        ...
        Sticky.allElements.map(function(s) {
            return s.isActive = Sticky.checkActive(s.elem),
            s.isFixedWidth = s.elem.classList.contains("Sticky--fixedWidth"),
            s.isReversed ? void i.unshift(s) : (s.offset = t,
            s.forceUpdate = !0,
            s.isActive || (s.isStuck = !1),
            void (s.update() && (s.zIndex = e,
            e++,
            t += s.isActive ? s.content.offsetHeight : 0)))
        }),
        t = 0,
        e = 999,
        i.map(function(i) {
    ...
    calcLimiterOffset: function(t, e, i, s, n) {
        ...
        if (t) {
            ...
            c = e.getBoundingClientRect().top - s;
        return c < n ? (i.style.zIndex = "",
        c) : n
    }
}),
Sticky.prototype = {
    ...
    listen: function() {
        ...
        document.addEventListener("scroll", e.bind(this)),
    ...
    update: function() {
        ...
        if (this.isActive && Sticky.isScrolledOff(this.elem, this.offset, this.isReversed, this.isOffscreen)) {
            if (!this.isStuck || this.forceUpdate || this.limiter) {
                ...
                if (s && (i = Sticky.calcLimiterOffset(this.isReversed, s, this.content, this.elem.offsetHeight, i)),
...
SyncHeight.prototype = {
    ...
    getHeight: function(t) {
        ...
        return t.hasAttribute("data-syncheight-multiplier") && (i /= t.getAttribute("data-syncheight-multiplier")),
        i
    },
    setHeight: function(t) {
        var i = this.height;
        t.hasAttribute("data-syncheight-multiplier") && (i *= t.getAttribute("data-syncheight-multiplier")),
        t.style.height = i + "px"
    },
    reset: function() {
    ...
    update: function() {
        ...
        return document.body.classList.contains("is-preloading") ? requestAnimationFrame(this.update.bind(this)) : (this.reset(),
        void (this.elem.classList.contains("SyncHeight--disabled") || requestAnimationFrame(t.bind(this))))
    }
},
SyncHeight.init();
...
function Tabs(t) {
    this.elem = t,
    this.elem.tabs = this,
    this.tabs = t.querySelectorAll(".Tabs-link"),
    this.tabsName = t.getAttribute("data-tabs"),
    this.isUnselectable = t.classList.contains("Tabs--unselectable"),
    this.isDefault = t.classList.contains("Tabs--default"),
    this.isSave = t.classList.contains("Tabs--save"),
    this.init()
}
Object.assign(Tabs, {
    hashReg: /(#.*)?$/,
    ...
    onclick: function(t, e) {
        ...
        i.map(function(t) {
            ...
            i.tabs.click(t),
            i && i.offsetWidth > 0 && i.offsetHeight > 0 && Tabs.scrollTo(i)
        })
    },
    scrollTo: function(t, e) {
        for (var i = 0, s = t; s && s != document.body; )
            i += s.offsetTop,
            s = s.offsetParent;
        var a = Tabs.getScrollTop()
          ...
          , c = a > i
          , l = a + n < i;
        SiteNav && SiteNav.getStickyOffset && (i -= SiteNav.getStickyOffset()),
        (c || l || e) && Tabs.setScrollTop(i)
    },
...
Tabs.prototype = {
    ...
    listen: function(t) {
        t.addEventListener("click", this.onclick.bind(this, t)),
        t.addEventListener("mousedown", Tabs.stop)
    },
    click: function(t) {
        this.click.active = !0,
        t.trigger("click")
    ...
    onclick: function(t) {
        this.click.active ? (this.click.active = !1,
        this.select(t)) : Tabs.onclick(t)
    },
    save: function() {
        if (!this.isSave)
            return !1;
    ...
    load: function() {
        ...
        if (i) {
            ...
            var s = document.querySelector(".SiteNav")
              , a = 0;
            return s.addEventListener("update", t),
            !0
        }
        return !1
    },
    ...
    select: function(t) {
        ...
        e ? this.isUnselectable && (this.tabs.map(this.clearSelection.bind(this)),
        this.removeSelection(this.elem)) : (this.tabs.map(this.clearSelection.bind(this)),
        this.addSelection(this.elem),
        this.addSelection(t),
        this.findTab(t).map(this.addSelection.bind(this))),
    ...
    clearSelection: function(t) {
        ...
        e && this.findTab(t).map(this.removeSelection.bind(this))
    },
    findTab: function(t) {
...
function TalentCalculator(t) {
    ...
    this.classes = t.querySelectorAll(".TalentCalculator-class"),
    this.specs = t.querySelectorAll(".TalentCalculator-spec"),
    this.shares = t.querySelectorAll(".TalentCalculator-share"),
    this.resets = t.querySelectorAll(".TalentCalculator-reset"),
    this.tiers = t.querySelectorAll(".TalentCalculator-tier"),
    this.talents = this.tiers.map(function(t) {
        return t.querySelectorAll(".TalentCalculator-talent")
    }),
    this.petSpecOptions = t.querySelectorAll(".TalentCalculator-petSpecOption"),
    this.petSpecs = t.querySelectorAll(".TalentCalculator-petSpecAbilities"),
    this.init()
}
...
TalentCalculator.prototype = {
    ...
    listenTier: function(t, e) {
        var i = this
          , s = this.talents[e];
        s.map(function(e) {
            e.addEventListener("click", i.toggleTier.bind(i, t, s)),
            e.querySelector(".TalentCalculator-select").addEventListener("click", i.select.bind(i, t, s, e)),
            e.querySelector(".TalentCalculator-unselect").addEventListener("click", i.unselect.bind(i, t, s, e)),
            e.querySelector(".Talent-checkboxInput").addEventListener("click", i.handleTalentCheckboxClick.bind(i, t, s, e))
        })
    },
    listenPetSpec: function(t) {
        t.querySelector(".TalentCalculator-select").addEventListener("click", this.selectPetSpec.bind(this, t)),
        t.querySelector(".TalentCalculator-unselect").addEventListener("click", this.unselectPetSpec.bind(this, t)),
        t.querySelector(".TalentCalculator-petSpecAbilitiesClose").addEventListener("click", function(e) {
    ...
    handleTalentCheckboxClick: function(t, e, i, s) {
        s.stopPropagation(),
        s.currentTarget.checked ? this.selectTalent(t, e, i) : this.unselectTalent(t, e, i)
    },
    handleClassClick: function(t, e, i) {
        var s = i.currentTarget.getAttribute("data-subtitle");
        this.setSubtitle(s),
        this.hideIntro(),
        this.syncHeightUpdate(t, e)
    },
    ...
    toggleTier: function(t, e) {
        t.classList.toggle("TalentCalculator-tier--active"),
        this.syncHeightUpdate(t, t.classList.contains("TalentCalculator-tier--active")),
        e.map(this.toggleTalent.bind(this))
    },
    collapseTier: function(t, e) {
        t.classList.remove("TalentCalculator-tier--active"),
        this.syncHeightUpdate(t, t.classList.contains("TalentCalculator-tier--active")),
        e.map(function(t) {
            t.Talent.collapse()
        })
    ...
    select: function(t, e, i) {
        e.map(this.removeSelection.bind(this)),
        this.addSelection(i),
        this.addSelection(t),
        this.save()
    },
    selectPetSpec: function(t, e) {
        this.petSpecOptions.map(function(t) {
            ...
            t.petSpecTab.classList.remove("is-active")
        }),
        t.classList.add("is-active"),
        t.petSpecTabLink.petSpecOption.classList.add("is-active"),
        this.save()
    },
    addSelection: function(t) {
    ...
    unselectPetSpec: function(t) {
        t.classList.remove("is-active"),
        t.petSpecTabLink.petSpecOption.classList.remove("is-active"),
        this.save()
    },
    removeSelection: function(t) {
        t.Talent && t.Talent.unselect(),
        t.classList.remove("is-selected")
    },
    save: function() {
        var t = this;
    ...
    "export": function() {
        ...
        var e, i, s, a, l, c, n, r, o, u = [];
        return i = this.classes.match(".is-selected"),
        i && (e = i.getAttribute("data-tab"),
        a = this.specs.match('[data-tab^="' + e + '/"].is-selected'),
        a ? (s = a.getAttribute("data-tab"),
        l = this.elem.querySelector('.Tab[data-tab="' + s + '"]'),
        u.push(s)) : u.push(e)),
        l && (tiers = l.querySelectorAll(".TalentCalculator-tier"),
        c = tiers.map(t).join("").replace(/0+$/, ""),
        c && u.push("talents=" + c)),
        r = this.petSpecOptions.match(".is-active"),
        r && (o = r.querySelector(".Tabs-link"),
        n = o.getAttribute("data-tab"),
        u.push("pet=" + n)),
        u.join("/")
    },
    "import": function(t) {
        var e, i, s, a, l, c, n, r, o, u = this, h = t.split("/"), p = h.shift(), d = h.shift();
        if (p && (e = this.classes.match('[data-tab="' + p + '"]'),
        e && e.click()),
        d && (i = this.specs.match('[data-tab="' + p + "/" + d + '"]'),
        i && (i.click(),
        s = this.elem.querySelector(".Tab" + i.attributeSelector("data-tab")))),
        s) {
            for (l = s.querySelectorAll(".TalentCalculator-tier"); c = h.shift(); )
                if (n = c.split("=").shift().toLowerCase(),
                r = c.split("=").slice(1).join("="),
                n && r)
                    switch (n) {
                    case "talents":
                        o = r.replace(/\D/g, "").split(""),
                        o.map(function(t, e) {
                            var i = parseInt(t)
                              , s = l[e];
                            if (i > 0 && s) {
                        ...
                        break;
                    case "pet":
                        a = this.petSpecs.match('[data-tab="' + r + '"]'),
                        a && u.selectPetSpec(a, !1);
                    case "glyphs":
                    }
            this.save()
        }
...
function Tooltip(t) {
    ...
    this.offset = parseFloat(t.getAttribute("data-tooltip-offset") || 20),
    this.init()
}
...
Tooltip.prototype = {
    ...
    set position(t) {
        null == t ? (this.elem.style.left = "0px",
        this.elem.style.top = "0px",
        delete this._position) : (this.elem.style.left = t.x - this.position.x + this.offset + "px",
        this.elem.style.top = t.y - this.position.y + this.offset + "px")
    },
    show: function() {
...
TooltipLink.prototype = {
    init: function() {
        this.elem.addEventListener("mouseover", this.show.bind(this)),
        this.elem.addEventListener("mouseout", this.hide.bind(this))
    },
    show: function() {
...
function Typeahead(e) {
    ...
    this.defaultContentDiv = e.querySelector(".Typeahead-defaultContent"),
    this.resultsContentDiv = e.querySelector(".Typeahead-resultsContent"),
    this.loadingMask = e.querySelector(".Typeahead-loadingMask"),
    this.url = e.getAttribute("data-typeahead-url"),
    this.searchInput = document.querySelector("#" + e.getAttribute("data-typeahead-input-id")),
    this.isActive = !1,
...
Typeahead.prototype = {
    ...
    onInputChange: function(e) {
        ...
        t && t.trim().length >= 3 ? (this.active || this.addActive(),
        this.insertTypeaheadResultsDiv(t)) : this.active && this.clearTypeaheadResults()
    },
...
Video.prototype = {
    ...
    youtube: function() {
        ...
        if (e) {
            ...
            s.src = "https://www.youtube.com/embed/" + e + "?wmode=transparent&autohide=1&showinfo=0&controls=0",
            s.setAttribute("allowfullscreen", ""),
            s.classList.add("Video-iframe"),
            this.iframe = s,
...
function VideoPane(i) {
    ...
    this.video = i.querySelector(".VideoPane-video"),
    this.videoInitialized = !1,
    this.init()
}
