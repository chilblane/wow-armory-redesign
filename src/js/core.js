...
function CustomEvent(t, e) {
    ...
    return i.initCustomEvent(t, e.bubbles || !1, e.cancelable || !1, e.detail),
    i
}
function trigger(t, e) {
    ...
    switch (t) {
    case "resize":
        "function" == typeof UIEvent ? i = new UIEvent(t) : (i = document.createEvent("UIEvent"),
        i.initUIEvent(t, !0, !0, window, 1));
        break;
    default:
        var n = null;
        null != e && (n = {
...
function SVG(t) {
    if (this.elem = t,
    this.href = t.getAttribute("xlink:href"),
    this.href) {
        var e = this.href.indexOf("#");
        this.url = this.href.substr(0, e),
        this.id = this.href.substr(e + 1),
        this.init()
    }
}
...
polyfill(Array.prototype, "each", Array.prototype.forEach),
...
polyfill(Object, "assign", function(t, e) {
    ...
    Array.from(arguments).slice(1).map(n),
    t
}),
polyfill(Element.prototype, "matches", Element.prototype.msMatchesSelector),
["indexOf", "slice", "forEach", "each", "map", "reduce", "filter", "every", "some"].each(function(t) {
...
Object.defineProperty(Node.prototype, "textNodes", {
    ...
    get: function() {
        for (var t, e = {
            ...
            NOSCRIPT: !0,
            STYLE: !0
        }, i = [], n = document.createTreeWalker(this, NodeFilter.SHOW_TEXT, null, !1); t = n.nextNode(); )
            e[t.parentNode.nodeName] || i.push(t);
        return i
    }
}),
...
polyfill(Array.prototype, "sortBy", function(t, e) {
    ...
    t && (i = Object.prototype.toString,
    n = Array.prototype.toString,
    Object.prototype.toString = r,
    Array.prototype.toString = r),
    e ? Array.prototype.sort.call(this, e) : Array.prototype.sort.call(this),
    t && (Object.prototype.toString = i,
    Array.prototype.toString = n),
    this
}),
"classList"in document.documentElement || (DOMTokenList.prototype = {
    add: function(t) {
        this.contains(t) || (Array.prototype.push.call(this, t),
    ...
    remove: function(t) {
        if (this.contains(t)) {
            for (var e = 0; e < this.length; e++)
                this[e] == t && Array.prototype.splice.call(this, e--, 1);
            this.element.className = this.toString()
        }
    },
    toString: function() {
...
polyfill(Element.prototype, "trigger", trigger),
window.trigger = trigger,
polyfill(Date, "now", function() {
    return (new Date).getTime()
}),
window.performance = window.performance || {},
polyfill(performance, "now", function() {
    return Date.now()
}),
...
querySelectorAlways.attribute = "queryselectoralways",
querySelectorAlways.init = function() {
    querySelectorAlways.style || (querySelectorAlways.style = document.createElement("style"),
    querySelectorAlways.style.id = "querySelectorAlways",
    querySelectorAlways.style.appendChild(document.createTextNode("")),
    document.head.appendChild(querySelectorAlways.style),
    ["animationstart", "MSAnimationStart", "webkitAnimationStart"].map(function(t) {
...
,
querySelectorAlways.selectors = {},
querySelectorAlways.callbacks = [],
querySelectorAlways.addSelector = function(t, e) {
    t = t.trim();
    var i = querySelectorAlways.selectors[t];
    return i ? querySelectorAlways.callbacks[i].push(e) : (i = querySelectorAlways.callbacks.length,
    querySelectorAlways.selectors[t] = i,
    querySelectorAlways.callbacks[i] = [e],
    querySelectorAlways.install(i, t)),
    i
}
,
...
querySelectorAlways.install = function(t, e) {
    ...
    var n = (querySelectorAlways.style,
    "querySelectorAlways" + t)
      , r = "visibility:hidden!important;"
      , o = ":not([" + querySelectorAlways.attribute + '~="' + t + '"])';
    e = e.replace(/(,|$)/g, function(t) {
        return o + t
    }),
    i(e + " { " + r + " animation: 0.001ms " + n + "!important; -webkit-animation: 0.001ms " + n + "!important; }"),
    i("@keyframes " + n + " { from { opacity: 0.999; } to { opacity: 1; } }"),
    i("@-webkit-keyframes " + n + " { from { opacity: 0.999; } to { opacity: 1; } }\n")
}
,
querySelectorAlways.regexEvent = /querySelectorAlways(\d+)/,
querySelectorAlways.onanimationstart = function(t) {
...
querySelectorAlways.addNode = function(t, e) {
    ...
    if (n.indexOf(String(t)) < 0) {
        n.push(t),
        e.setAttribute(querySelectorAlways.attribute, n.join(" "));
...
Media.sizes = ["original", "small", "medium", "large", "wide", "huge", "max", "edge", "over"],
Media.attrs = Media.sizes.map(function(t) {
    return "media-" + t
}),
Media.query = Media.attrs.map(function(t) {
    return "[" + t + "]"
}).join(","),
Media.widths = [0, 320, 540, 720, 980, 1280, 1600, 2400, 9e3],
Media.spaceReg = /\s+/,
Media.prototype = {
    init: function() {
        this.update(),
    ...
    addElem: function(t) {
        t.setAttribute("media-original", t.className),
        this.elems.push(t),
        this.updateElem(t)
    },
    update: function() {
...
Mouse.prototype = {
    init: function() {
        ...
        window.addEventListener("touchstart", this.update.bind(this)),
...
SVG.prototype = {
    ...
    svg: function() {
        var t = document;
        return this.url && (t = SVG.svgs[this.url],
        t || (t = SVG.svgs[this.url] = this.ajax(this.url))),
        t
    },
    ajax: function(t) {
        function e() {
            if (i.status < 400) {
                ...
                e.body.innerHTML = i.responseText,
                SVG.svgs[t] = e.querySelector("svg")
            }
        }
        var i = new XMLHttpRequest;
        return i.open("GET", encodeURI(t), !0),
    ...
    set: function(t) {
        if (t) {
            for (var e = t.cloneNode(!0), i = document.createDocumentFragment(); e.firstChild; )
        ...
        if (!(e.indexOf("?") < 0)) {
            ...
            e.split("?").each(function(t, e) {
                if (e) {
                    ...
                    n.className = "fontFamily-blizzard",
                    n.textContent = "?",
                    i.appendChild(n)
                }
